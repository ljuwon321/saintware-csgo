                ...
                while (!_loaded)
                {
                    ...
                    while (!_modulesLoaded)
                    {
                        ...
                        foreach (ProcessModule _module in _process.Modules)
                        {
                            ...
                            {
                                Console.WriteLine("Found client.dll");
                            ...
                            {
                                Console.WriteLine("Found engine.dll");
                            ...
                            {
                                Console.WriteLine("Found vstdlib.dll");
                            ...
                            {
                                Console.WriteLine("Found inputsystem.dll");
                            ...
                            {
                                Console.WriteLine("Found steam_api.dll");
